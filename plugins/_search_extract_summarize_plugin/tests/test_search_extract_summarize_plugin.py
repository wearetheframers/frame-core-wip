...
#     mock_requests.get.return_value.json.return_value = {"results": [{"link": "http://example.com"}]}
#     mock_bs.return_value.get_text.return_value = "Sample text"
#     mock_openai.return_value.chat.completions.create.return_value.choices[0].message.content = "Summarized content"
...
#     with patch('frame.src.plugins.search_extract_summarize_plugin.requests') as mock_requests:
