...
from frame.src.framer.agency.actions.generate_roles_and_goals import GenerateRolesAndGoals
...
async def test_generate_roles_and_goals(mock_execution_context):
    action = GenerateRolesAndGoals(name="Generate Roles and Goals", description="Generate roles and goals for the framer")
