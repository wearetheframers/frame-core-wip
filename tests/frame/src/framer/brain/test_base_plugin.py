...
class TestBasePlugin(unittest.TestCase):
    ...
    def test_add_action(self):
        ...
        self.plugin.add_action("think", think_action, "Think about something", Priority.HIGH)
    ...
    def test_add_research_action(self):
        ...
        self.plugin.add_action("research", research_action, "Research a topic", Priority.MEDIUM)
        actions = self.plugin.get_actions()
